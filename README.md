...
## Setup Instructions
* git clone https://github.com/kiirudavid/Akan-name.git on your terminal.
...
## Contribution
Incase of any contributions, feel free to do so by visiting[this link](https://github.com/kiirudavid/Akan-name.git).
### License
